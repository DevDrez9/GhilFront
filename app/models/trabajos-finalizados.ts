...
export type CreateTrabajoFinalizadoDto = Omit<TrabajoFinalizadoResponseDto, 'id' | 'createdAt' | 'updatedAt' | 'trabajoEnProceso' | 'tienda' | 'movimientosInventario'>;